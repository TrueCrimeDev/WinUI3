...
_rt_CacheAttributeCtors(mdi, o, retprop) {
    ...
    ; Find the assembly ref scope containing Windows.Foundation.Metadata attributes.
    ; Different metadata files use different assembly ref names:
    ;   Windows.Foundation.winmd: mdModule (scope 1)
    ;   Microsoft.UI.winmd: "Windows"
    ;   Microsoft.UI.Xaml.winmd: "Windows.Foundation.FoundationContract"
    ...
    defAttr(o, n, v) {
        ...
        } else if o.%n% != v && v != -1 && o.%n% != -1 {
            ; Multiple constructor overloads exist. Store as array for multi-token enum.
            prev := o.%n%
            o.DefineProp n, {value: prev is Array ? (prev.Push(v), prev) : [prev, v]}
        }
    }
